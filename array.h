...
#if _DEBUG
#define DEBUG_ABARRAY_HANDLES 1
#endif
...
assert_static(!(sizeof(ArrayHdr)%sizeof(void*))); // alignment

#define ABARRAY_MEMSIZE(CAP) ((CAP)*(sizeof(TYPE_T))+sizeof(ArrayHdr))
#define ABARRAY_FROM_T(P) (P?((ArrayHdr*)(((U8*)(P))- sizeof(ArrayHdr))):0)
#define T_FROM_ABARRAY(P) (P?((TYPE_T*)(((U8*)(P)) + sizeof(ArrayHdr))):0)
...
#define aint_destroy(handle) aint_destroy(handle DBG_PARMS_INIT)
...
assert_static(!(sizeof(ArrayHack)%sizeof(void*))); // alignment
